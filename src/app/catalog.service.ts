...
export class CatalogService {
  ...
  private async seed() { for (const p of [{barcode:'7750182001123',name:'Agua mineral 625 ml',price:2.5,tags:['Bebidas']},{barcode:'7751271009872',name:'Galletas de vainilla',price:3.9,tags:['Snacks','Oferta']},{barcode:'7501055362843',name:'Detergente líquido 1 L',price:15.9,tags:['Limpieza']}]) await this.save({...p,updatedAt:Date.now()}); }
}
